...
```json
{
  ...
  "evidence": [
    {
      "source": "step3",
      "source_file": ".analysis/1234567892/step3_correlation.json",
    ...
    {
      "source": "step1",
      "source_file": ".analysis/1234567892/step1_job_context.json",
  ...
  "difficulty": "hard",
  "difficulty_score": 8,
  "difficulty_justification": "Evidence Availability (+3): Requires correlating AAP job, Splunk timeout logs, and step3 timeline to see retry pattern. Confusion Factors (+3): Generic timeout error, timing dependencies reveal transient nature, multiple plausible alternatives (cloud outage vs code bug vs network). Domain Expertise (+2): Requires cloud API knowledge and understanding transient vs permanent failures. Total: 8 = hard.",
  "difficulty_appropriate": true,
  "difficulty_comment": "",
...
```json
{
  ...
  "evidence": [
    {
      "source": "step3",
      "source_file": ".analysis/1234567893/step3_correlation.json",
      "json_path": "splunk_errors[0].message",
    ...
    {
      "source": "step1",
      "source_file": ".analysis/1234567893/step1_job_context.json",
  ...
  "difficulty": "easy",
  "difficulty_score": 2,
  "difficulty_justification": "Evidence Availability (+1): Clear from AAP logs alone, 401 Unauthorized with exact ServiceAccount name. Confusion Factors (+0): No misleading signals, error is specific. Domain Expertise (+1): Requires basic K8s RBAC knowledge. Total: 2 = easy.",
  "difficulty_appropriate": true,
  "difficulty_comment": "",
