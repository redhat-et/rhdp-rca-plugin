...
def cmd_analyze(args: argparse.Namespace, config: Config) -> int:
    ...
    print("\n[Next Step] Run Step 4 to fetch GitHub files and analyze")
    print(f"  Command: .venv/bin/python scripts/step4_fetch_github.py --job-id {job_id}")
    print("  This will create: step4_analysis_complete.json")
